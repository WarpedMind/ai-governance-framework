...
Score your organization on each dimension below using the scale provided. Be honest — this is for internal calibration, not external presentation. The value of this tool is in the gaps it surfaces, not the total score.

**Scoring scale:**  
`1` = Not in place / No awareness  
`2` = Early awareness, no formal action  
`3` = In progress / Partially addressed  
`4` = Established, working but not optimized  
`5` = Mature, documented, and consistently practiced
...
| Question | Score (1–5) |
|---|---|
| We have a clear inventory of what data we collect and where it lives | |
| Our data is consistently structured and accessible to the teams who need it | |
| We have documented data quality standards and someone accountable for them | |
| We can trace the lineage of data used in key business decisions | |
| We have policies governing how data is stored, accessed, and retired | |

**Dimension score: ___ / 25**

*Low scores here (under 12) are a strong signal to address data foundations before any significant AI investment. AI amplifies data quality — good and bad.*
...
| Question | Score (1–5) |
|---|---|
| Leadership understands what AI can and cannot realistically do | |
| At least one person in the organization has hands-on AI/ML experience | |
| Employees are generally curious about AI rather than fearful of it | |
| We have a culture of experimentation where failure is acceptable as learning | |
| We have budget and willingness to invest in AI-related training | |

**Dimension score: ___ / 25**

*Culture resistance is the most common reason AI initiatives stall. Technical barriers are usually solvable; cultural ones require sustained leadership attention.*
...
| We measure and track key operational metrics regularly | |
| We have a defined process for evaluating and adopting new technology | |
...
*Part of the [AI Governance Framework](../README.md) maintained by Thomas C. Grow II*  
